    ...
    <div
      ...
      <div>
          ...
          <div class="flex items-center bg-white border-b border-gray-200 px-5 h-16">
            <div class="w-full flex items-center justify-between">
              <button
                ...
                <svg class="w-6 h-6 fill-current text-blue-600 mr-1 shrink-0" viewBox="0 0 24 24">
        ...
        <div class="px-5 py-4">
          <div class="mt-4">
            <ul class="mb-6">
              <li v-for="raboten in store.state.rabotni_temp" :key="raboten.id" class="-mx-2 mb-2">
                <button class="flex w-full p-1 text-left hover:bg-indigo-100 border hover:border-indigo-200" :class="[
                  ...
                  <div class="grow truncate">
                    <div class="flex items-center justify-between mb-0.5">
                      <div class="flex flex-grow text-sm text-gray-500 font-medium truncate">
                    ...
                    <div class="flex justify-between text-sm text-gray-500 font-medium truncate">
                      <div>
                        <span class="text-red-600">№&nbsp;{{ raboten.id }}</span>&nbsp;<span
                          class="text-gray-300">|</span>&nbsp;Оферта&nbsp;-&nbsp;{{ raboten.idnomber }}
                      </div>
                ...
                "
                  ...
                  <div
                    ...
                    v-for="poseshtenie in poseshtenia" :key="poseshtenie.id" :class="
