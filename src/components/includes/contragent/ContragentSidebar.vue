<template>
  <div
    ...
    :class="
      store.state.contragentSidebarOpen ? 'translate-x-0' : '-translate-x-full'
    "
  >
    <div
...
import ContragentForm from './ContragentForm.vue'

export default {
  name: 'ContragentSidebar',

  components: { ContragentForm },
