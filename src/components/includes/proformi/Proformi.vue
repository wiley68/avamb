  ...
  <div class="sticky top-0 z-10 bg-white">
    <div class="flex items-center bg-white border-b border-gray-200 px-5 h-16">
      <div class="w-full flex items-center justify-between">
        <div class="">
          <button v-if="store.state.current_oferti !== 0"
    ...
    <ul class="mb-6">
      <li v-for="proforma in getProformi()" :key="proforma.id" class="-mx-2 mb-1">
        <button class="flex flex-col w-full p-1 text-left bg-gray-100 rounded border border-gray-200"
          ...
          <div class="flex w-full">
            <div class="flex-none">
              <span class="text-sm font-medium text-gray-500 mr-1">Частично плащане - {{ formatDateTime(proforma.dateon)
              }}</span><span class="text-gray-400">|</span>
            </div>
