<template>
    ...
    <div class="grow pt-4">
        <div
            ...
            <div class="flex flex-col mt-2 w-full">
                <input type="text" class="w-full text-sm border rounded-sm border-gray-100 p-1"
                    placeholder="Сума на аванс 1" v-model="proforma.price_avans1" />
            </div>
            <div class="flex flex-col mt-2 w-full">
            ...
            <div class="flex flex-col mt-1 w-full">
                <textarea rows="8" class="w-full text-sm border rounded-sm border-gray-100 p-1"
                    v-model="proforma.description"></textarea>
            </div>
            ...
            <div v-for="dds in proforma.dds" :key="dds.name"
    ...
    <ModalBlank id="success-modal" :modalOpen="store.state.successUpdateProforma"
