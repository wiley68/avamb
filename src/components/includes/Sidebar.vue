    ...
    <div class="space-y-8">
      <div>
        ...
        <ul class="mt-3">
          ...
          <SidebarLinkGroup
            v-slot="parentLink"
            :activeCondition="store.state.activeConditionRegister"
            ><a
              class="block text-gray-200 hover:text-white truncate transition duration-150"
              :class="
                store.state.activeConditionRegister && 'hover:text-gray-200'
              "
              href="#0"
              @click.prevent="
                store.state.sidebarOpen
            ...
            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
              ...
              >
                ...
                >
                  <div
                    class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Modul1')"
                  >
                    <div class="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <div
                    class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Modul2')"
                  >
                    <div class="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <div
                    class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Modul3')"
                  >
                    <div class="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <div
                    class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Modul4')"
                  >
                    <div class="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <div
                    class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Modul5')"
                  >
                    <div class="flex items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <ul class="mt-3">
          ...
          >
            ...
            >
              <div class="flex items-center">
                <svg
                  class="shrink-0 h-6 w-6 rotate-180"
                  viewBox="0 0 24 24"
                >
                  <path
                    fill="currentColor"
