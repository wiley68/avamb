    ...
    <div class="space-y-8">
      <div>
        <h3 class="text-xs uppercase text-gray-500 font-semibold pl-3">
          <span class="hidden lg:block 2xl:hidden text-center w-6" aria-hidden="true"
            >•••</span
          >
        ...
        <ul class="mt-3">
            ...
            >
              <div class="flex items-center">
                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                  <path
                    :class="
                      store.state.page == 'Dashboard' ? '!text-lime-500' : 'text-gray-400'
                    "
                    fill="currentColor"
                    d="M4,1H20A1,1 0 0,1 21,2V6A1,1 0 0,1 20,7H4A1,1 0 0,1 3,6V2A1,1 0 0,1 4,1M4,9H20A1,1 0 0,1 21,10V14A1,1 0 0,1 20,15H4A1,1 0 0,1 3,14V10A1,1 0 0,1 4,9M4,17H20A1,1 0 0,1 21,18V22A1,1 0 0,1 20,23H4A1,1 0 0,1 3,22V18A1,1 0 0,1 4,17M9,5H10V3H9V5M9,13H10V11H9V13M9,21H10V19H9V21M5,3V5H7V3H5M5,11V13H7V11H5M5,19V21H7V19H5Z"
                  />
            ...
            >
              <div class="flex items-center">
                ...
                >
                  <path
                    :class="
                      store.state.page == 'Messages' ? '!text-lime-500' : 'text-gray-400'
                    "
                    fill="currentColor"
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <svg class="w-6 h-6 shrink-0" viewBox="0 0 24 24">
                    <path
                      :class="
                        store.state.page == 'Zadaci' ? '!text-lime-500' : 'text-gray-400'
                      "
                      fill="currentColor"
            ...
            >
              <div class="flex items-center">
                <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                  <path
                    :class="
                      store.state.page == 'Products' ? '!text-lime-500' : 'text-gray-400'
                    "
                    fill="currentColor"
          ...
          <SidebarLinkGroup
            ...
            ><a
              class="block text-gray-200 hover:text-white truncate transition duration-150"
              :class="store.state.activeConditionDocuments && 'hover:text-gray-200'"
              href="#0"
              @click.prevent="
                store.state.sidebarOpen
                  ? parentLink.handleClick()
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <svg
                    ...
                    :class="
                      store.state.page == 'Documents' ? '!text-lime-500' : 'text-gray-400'
                    "
                    viewBox="0 0 24 24"
                  >
                    <path
            ...
            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
              <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                ...
                <li
                  class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
                  :class="store.state.page == 'Fakturi' ? 'bg-gray-900' : ''"
                >
                  <div
                    class="block text-gray-200 truncate transition duration-150"
                    :class="
                      store.state.page == 'Fakturi'
                        ? 'hover:text-gray-200'
                        : 'hover:text-white'
                    "
                    @click="store.methods.changePage('Fakturi')"
                  >
                    <div class="flex items-center">
                      <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                        <path
            ...
            >
              <div class="flex items-center">
                <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                  <path
                    :class="
                      store.state.page == 'Register' ? '!text-lime-500' : 'text-gray-400'
                    "
                    fill="currentColor"
          ...
          >
            <div
              class="block text-gray-200 truncate transition duration-150"
              :class="
                store.state.page == 'Shop' ? 'hover:text-gray-200' : 'hover:text-white'
              "
            ...
            >
              <div class="flex items-center">
                <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                  <path
                    :class="
                      store.state.page == 'Shop' ? '!text-lime-500' : 'text-gray-400'
                    "
                    fill="currentColor"
