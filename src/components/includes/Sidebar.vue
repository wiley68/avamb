<template>
  <div class="fixed inset-0 bg-gray-900 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200" :class="
  ...
  <div id="sidebar" ref="sidebar"
    ...
    <div class="flex justify-between mb-10 pr-3 sm:px-2">
      <button ref="trigger" class="lg:hidden text-gray-500 hover:text-gray-400"
        @click.stop="store.methods.closeSidebar()" aria-controls="sidebar" :aria-expanded="store.state.sidebarOpen">
    ...
    <div class="space-y-8">
      <div>
        <h3 class="text-xs uppercase text-gray-500 font-semibold pl-3">
          <span class="hidden lg:block 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
          <span class="lg:hidden 2xl:block">{{ store.state.name }}</span>
        </h3>
        <ul class="mt-3">
          <!-- Dashboard -->
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            :class="store.state.page == 'Dashboard' ? 'bg-gray-900' : ''">
            <div class="block text-gray-200 truncate transition duration-150" :class="
            ...
            " @click="store.methods.changePage('Dashboard')">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Етапна
                  визуализация</span>
              </div>
            </div>
          </li>
          ...
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            ...
            " @click="store.methods.changePage('Messages')">
              <div class="flex items-center">
                <svg class="shrink-0 w-6 h-6" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  <path :class="
                    store.state.page == 'Messages'
                      ? '!text-lime-500'
                      : 'text-gray-400'
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Съобщения</span>
              </div>
            </div>
          </li>
          <!-- Firm -->
          <SidebarLinkGroup v-slot="parentLink" :activeCondition="store.state.activeConditionFirms"><a
              class="block text-gray-200 hover:text-white truncate transition duration-150"
              :class="store.state.activeConditionFirms && 'hover:text-gray-200'" href="#0" @click.prevent="
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <span
                    class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Фирма
                  </span>
                </div>
                <!-- Icon -->
            ...
            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
              <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Данни</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Бланки</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">МПС</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span
                        class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Потребители</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
                  ...
                  " @click="changePageZadaci()">
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Задачи</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Статистики</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Отчет</span>
                    </div>
                  </div>
                </li>
              </ul>
          ...
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            ...
            " @click="store.methods.changePage('Nomenklatures')">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Номенклатури</span>
              </div>
            </div>
          </li>
          <!-- Contragents -->
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            ...
            " @click="store.methods.changePage('Contragents')">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Контрагенти</span>
              </div>
            </div>
          </li>
          <!-- Products -->
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            ...
            " @click="store.methods.changePage('Products')">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Продуктова база</span>
              </div>
            </div>
          </li>
          <!-- Documents -->
          <SidebarLinkGroup v-slot="parentLink" :activeCondition="store.state.activeConditionDocuments"><a
              class="block text-gray-200 hover:text-white truncate transition duration-150" :class="
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <svg class="w-6 h-6 shrink-0" :class="
                  ...
                  <span
                    class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Документи
                  </span>
                </div>
                <!-- Icon -->
                <div class="flex shrink-0 ml-2">
                ...
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Оферти</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Договори</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Proformi')">
                    <div class="flex items-center">
                      <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                        <path :class="
                          store.state.page == 'Documents'
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Проформи</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    @click="store.methods.changePage('Avansovi')">
                    <div class="flex items-center">
                      <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                        <path :class="
                          store.state.page == 'Documents'
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Авансови
                        фактури</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
                  ...
                  " @click="store.methods.changePage('Zadaci')">
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Фактури
                        (продажби)</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Складова
                        разписка</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <div class="block text-gray-200 truncate transition duration-150"
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Експедиционна
                        бележка</span>
                    </div>
                  </div>
                </li>
                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
                  <button class="block text-gray-200 truncate transition duration-150" @click="changePageRabotni()">
                    <div class="flex items-center">
                      <svg class="shrink-0 w-6 h-6" viewBox="0 0 24 24">
                        <path :class="
                          store.state.page == 'Documents'
                      ...
                      <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Работни
                        листи</span>
                    </div>
                  </button>
                </li>
          ...
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            ...
            " @click="store.methods.changePage('Register')">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Регистър</span>
              </div>
            </div>
          </li>
          <!-- Shop -->
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900"
            ...
            " @click="store.methods.changePage('Shop')">
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Онлайн магазин</span>
              </div>
            </div>
          </li>
        </ul>
          ...
          <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 cursor-pointer hover:bg-gray-900">
            <a href="/login/logout.php"
              ...
              <div class="flex items-center">
                ...
                <span class="text-sm font-medium ml-3 lg:opacity-0 2xl:opacity-100 duration-200">Изход</span>
              </div>
            </a>
          </li>
        </ul>
